//
//  PeripheralConnectioProvider+ResultProtocol.swift
//  ReactiveBluetooth
//
...
public extension ResultProtocol where Value: PeripheralConnectionProvider, Error: PeripheralConnectionErrorProvider {
