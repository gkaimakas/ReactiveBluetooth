...
public class SyncArray<Element>: NSObject {
	...
	public override init() {
		self.store = []
		self.queue = DispatchQueue(label: "com.gkaimakas.ReactiveBluetooth.SyncArray", attributes: .concurrent)
...
extension Reactive where Base: SyncArray<DiscoveredPeripheral> {
